                ...
                <div class="container-fluid">
					...
					<div class="row">
						<div class="col md-2">
							<button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#newMenuModal">Tambah Golongan</button>
						</div>
                    ...
                    <div class="row mt-3">
				      ...
				      <div class="col-md-12">
				        ...
				        <thead>
				          <tr>
				            <th scope="col">#</th>
				            <th class="col-xs-5">Golongan</th>
				            <th class="col-xs-5">Tunjangan</th>
				        ...
				        <tbody>
				        	<?php 
					          ...
					          <tr>
					            ...
					            <td class="col-xs-5"><?= $value->bobot; ?></td>
								<td style="width:12%">
									<!-- <a class="btn btn-warning btn-sm" href="<?=base_url();?>master_data/edit_event?id=<?=$value->id;?>">edit</a> -->
									<a class="btn btn-danger btn-sm" href="<?=base_url();?>master_data/do_delete_golongan?id=<?=$value->id;?>">hapus</a>
								</td>
					          </tr>
				        	<?php $i++; endforeach; ?>  
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?= base_url('master_data/do_add_edit_golongan'); ?>" method="post">
	      <div class="modal-body">
            <input type="hidden" id="id" name="id">
	        <div class="form-group">
		        <input type="text" class="form-control" id="golongan" name="golongan" placeholder="masukan nama golongan">
		    </div>
            <div class="form-group">
